...
Like many of us, I spent months saving links across browser tabs, notes apps, and bookmarks. This repository is my single source of truth: a dedicated personal space to organize, test, and reference those pieces in one place.

### What is inside

What started as a focused collection of design-related skills has grown alongside how we actually work today. You will find workflows, techniques, and resources touching:

* Design and creative systems  
* Product strategy and research  
* Engineering and development  
* Marketing and content  
* General productivity and operations  
* Agent tooling and autonomous helpers
