// deep-component-figma — full recursive node tree with resolved tokens, instance refs, reactions.
//
// Run via the native Figma MCP `use_figma` tool (pass skillNames: "deep-component-figma").
