// arrange-component-set-figma — organize variants into a labeled grid with a titled container.
//
// Run via the native Figma MCP `use_figma` tool (pass skillNames: "arrange-component-set-figma").
