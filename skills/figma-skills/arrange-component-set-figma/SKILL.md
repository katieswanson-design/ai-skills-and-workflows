---
name: arrange-component-set-figma
...
- **Understanding what the variants mean** (state machine, CSS) → use `analyze-component-set-figma`.
...
3. **Run** [`scripts/arrange-component-set.js`](scripts/arrange-component-set.js) via `use_figma`
   (`skillNames: "arrange-component-set-figma"`). Adjust `GAP` / `CELL_PADDING` constants if needed.
