// analyze-component-set-figma — variant state machine + CSS pseudo-class mapping + per-variant diffs.
//
// Run via the native Figma MCP `use_figma` tool (pass skillNames: "analyze-component-set-figma").
