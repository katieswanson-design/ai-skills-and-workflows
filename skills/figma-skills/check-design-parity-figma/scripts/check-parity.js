// check-design-parity-figma — diff a Figma node's specs against a code spec.
//
// Run via the native Figma MCP `use_figma` tool (pass skillNames: "check-design-parity-figma").
